...
import kr.edcan.hospital.activity.View_Tab_Info;
import kr.edcan.hospital.activity.View_Tab_Review;
...
public class ViewPager2Adapter extends FragmentStatePagerAdapter {
    ...
    public ViewPager2Adapter(FragmentManager fm, String mTitles[], int mNumbOfTabsumb) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return new View_Tab_Info();
            case 1:
                return new View_Tab_Review();
            default:
                return null;
        }
    }
